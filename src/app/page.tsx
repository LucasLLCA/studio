...
const andamentosArray = [
  {
    ...
    "Unidade": { "IdUnidade": "110006180", "Sigla": "SEAD-PI/SGP/CIASPI", "Descricao": "Diretoria do Ciaspi - SEAD-PI" },
    "Usuario": { "IdUsuario": "100027418", "Sigla": "thais.veloso@sead.pi.gov.br", "Nome": "Thaís Bemvindo Veloso" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006442", "Sigla": "SEAD-PI/GAB/SGACG/DLOG", "Descricao": "Diretoria de Logística e Abastecimento - DLOG" },
    "Usuario": { "IdUsuario": "100033540", "Sigla": "francisco.souza@sead.pi.gov.br", "Nome": "FRANCISCO DANIEL BATISTA E SOUZA" },
    "Atributos": []
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006442", "Sigla": "SEAD-PI/GAB/SGACG/DLOG", "Descricao": "Diretoria de Logística e Abastecimento - DLOG" },
    "Usuario": { "IdUsuario": "100033540", "Sigla": "francisco.souza@sead.pi.gov.br", "Nome": "FRANCISCO DANIEL BATISTA E SOUZA" },
    "Atributos": [{ "Nome": "BLOCO", "Valor": "417794", "IdOrigem": "417794" }]
  },
  {
    ...
    "Usuario": { "IdUsuario": "100034350", "Sigla": "francisco.luan@sead.pi.gov.br", "Nome": "FRANCISCO LUAN GOMES DE OLIVEIRA" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006178", "Sigla": "SEAD-PI/GAB/SGP", "Descricao": "Superintendência de Gestão de Pessoas - SEAD-PI" },
    "Usuario": { "IdUsuario": "100010235", "Sigla": "garcias.guedes@sead.pi.gov.br", "Nome": "GARCIAS GUEDES RODRIGUES JÚNIOR - Matr.0371160-9" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006183", "Sigla": "SEAD-PI/SGP/DUGP", "Descricao": "Diretoria de Unidade de Gestão de Pessoas - SEAD-PI" },
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006191", "Sigla": "SEAD-PI/SGP/DFPG", "Descricao": "Diretoria de Folha de Pagamento - SEAD-PI" },
    "Usuario": { "IdUsuario": "100000130", "Sigla": "geisa@sead.pi.gov.br", "Nome": "GEISA CRONEMBERGER DO RÊGO FERREIRA - Matr.0157016-1" },
    "Atributos": []
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100029425", "Sigla": "lucas.araujo@sead.pi.gov.br", "Nome": "LUCAS LOPES DE ARAUJO  Matr.391814-9" },
    "Atributos": []
  },
  {
    ...
    "Usuario": { "IdUsuario": "100029425", "Sigla": "lucas.araujo@sead.pi.gov.br", "Nome": "LUCAS LOPES DE ARAUJO  Matr.391814-9" },
    "Atributos": [
      { "Nome": "BLOCO", "Valor": "211071", "IdOrigem": "211071" },
      { "Nome": "UNIDADE", "Valor": "SEAD-PI/GAB/SGACG¥Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI", "IdOrigem": "110006157" }
    ]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100029425", "Sigla": "lucas.araujo@sead.pi.gov.br", "Nome": "LUCAS LOPES DE ARAUJO  Matr.391814-9" },
    "Atributos": [{ "Nome": "BLOCO", "Valor": "194737", "IdOrigem": "194737" }]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006442", "Sigla": "SEAD-PI/GAB/SGACG/DLOG", "Descricao": "Diretoria de Logística e Abastecimento - DLOG" },
    "Usuario": { "IdUsuario": "100010663", "Sigla": "annderson.bandeira@sead.pi.gov.br", "Nome": "ANNDERSON FELIPE BANDEIRA SILVA - Matr.372260-X" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [
      { "Nome": "BLOCO", "Valor": "182890", "IdOrigem": "182890" },
      { "Nome": "DOCUMENTO", "Valor": "9180488", "IdOrigem": "10326242" }
    ]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006442", "Sigla": "SEAD-PI/GAB/SGACG/DLOG", "Descricao": "Diretoria de Logística e Abastecimento - DLOG" },
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [{ "Nome": "UNIDADE", "Valor": "SEAD-PI/GAB/SGACG¥Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI", "IdOrigem": "110006157" }]
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100002138", "Sigla": "caroline.viveiros@sead.pi.gov.br", "Nome": "CAROLINE VIVEIROS MOURA DA CRUZ - Matr.0371165-0" },
    "Atributos": [
      { "Nome": "DOCUMENTO", "Valor": "9180488", "IdOrigem": "10326242" },
      { "Nome": "USUARIO", "Valor": "caroline.viveiros@sead.pi.gov.br¥CAROLINE VIVEIROS MOURA DA CRUZ - Matr.0371165-0", "IdOrigem": "100002138" }
    ]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [{ "Nome": "BLOCO", "Valor": "211071", "IdOrigem": "211071" }]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [{ "Nome": "DOCUMENTO", "Valor": "9180469", "IdOrigem": "10326221" }]
  },
  {
    ...
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [
      { "Nome": "DOCUMENTO", "Valor": "9180469", "IdOrigem": "10326221" },
      { "Nome": "NIVEL_ACESSO", "IdOrigem": "0" }
    ]
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006157", "Sigla": "SEAD-PI/GAB/SGACG", "Descricao": "Superintendência de Gestão Administrativa e Controle dos Gastos - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003402", "Sigla": "leandra.lustosa@sead.pi.gov.br", "Nome": "LEANDRA FERREIRA LUSTOSA MEDINA PRADO" },
    "Atributos": [{ "Nome": "USUARIO", "Valor": "leandra.lustosa@sead.pi.gov.br¥LEANDRA FERREIRA LUSTOSA MEDINA PRADO", "IdOrigem": "100003402" }]
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006178", "Sigla": "SEAD-PI/GAB/SGP", "Descricao": "Superintendência de Gestão de Pessoas - SEAD-PI" },
    "Usuario": { "IdUsuario": "100026349", "Sigla": "thallya.silva@sead.pi.gov.br", "Nome": "THALLYA PEREIRA GOMES DA SILVA - Matr.E.03610730" },
    "Atributos": [{ "Nome": "USUARIO", "Valor": "eurivan.castelo@sead.pi.gov.br¥EURIVAN CASTELO BRANCO COUTINHO - Matr.0371541-8", "IdOrigem": "100029070" }]
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006180", "Sigla": "SEAD-PI/SGP/CIASPI", "Descricao": "Diretoria do Ciaspi - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003483", "Sigla": "aline.carla@sead.pi.gov.br", "Nome": "ALINE CARLA DE MELO COELHO - Matr.0226622-9" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006183", "Sigla": "SEAD-PI/SGP/DUGP", "Descricao": "Diretoria de Unidade de Gestão de Pessoas - SEAD-PI" },
    "Usuario": { "IdUsuario": "100003114", "Sigla": "ana.clara@sead.pi.gov.br", "Nome": "ANA CLARA GOMES VELOSO" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006191", "Sigla": "SEAD-PI/SGP/DFPG", "Descricao": "Diretoria de Folha de Pagamento - SEAD-PI" },
    "Usuario": { "IdUsuario": "100000347", "Sigla": "marcia.pinheiro@sead.pi.gov.br", "Nome": "MÁRCIA VASCONCELOS ALVES DA CRUZ PINHEIRO - Matr.0091423-1" },
    "Atributos": [{ "Nome": "USUARIO", "Valor": "geisa@sead.pi.gov.br¥GEISA CRONEMBERGER DO RÊGO FERREIRA - Matr.0157016-1", "IdOrigem": "100000130" }]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006180", "Sigla": "SEAD-PI/SGP/CIASPI", "Descricao": "Diretoria do Ciaspi - SEAD-PI" },
    "Usuario": { "IdUsuario": "100010235", "Sigla": "garcias.guedes@sead.pi.gov.br", "Nome": "GARCIAS GUEDES RODRIGUES JÚNIOR - Matr.0371160-9" },
    "Atributos": [{ "Nome": "UNIDADE", "Valor": "SEAD-PI/GAB/SGP¥Superintendência de Gestão de Pessoas - SEAD-PI", "IdOrigem": "110006178" }]
  },
  {
  ...
  },
  {
    ...
    "Usuario": { "IdUsuario": "100010235", "Sigla": "garcias.guedes@sead.pi.gov.br", "Nome": "GARCIAS GUEDES RODRIGUES JÚNIOR - Matr.0371160-9" },
    "Atributos": [
      { "Nome": "DOCUMENTO", "Valor": "8942564", "IdOrigem": "10062608" },
      { "Nome": "USUARIO", "Valor": "garcias.guedes@sead.pi.gov.br¥GARCIAS GUEDES RODRIGUES JÚNIOR - Matr.0371160-9", "IdOrigem": "100010235" }
    ]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006178", "Sigla": "SEAD-PI/GAB/SGP", "Descricao": "Superintendência de Gestão de Pessoas - SEAD-PI" },
    "Usuario": { "IdUsuario": "100030668", "Sigla": "vanessa.lima@sead.pi.gov.br", "Nome": "Vanessa Bento Lima" },
    "Atributos": [{ "Nome": "USUARIO", "Valor": "thallya.silva@sead.pi.gov.br¥THALLYA PEREIRA GOMES DA SILVA - Matr.E.03610730", "IdOrigem": "100026349" }]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006324", "Sigla": "SEAD-PI/GAB/SUPARC", "Descricao": "Superintendência de Parcerias Público Privadas e Concessões - SEAD-PI" },
    "Usuario": { "IdUsuario": "100000238", "Sigla": "francisca.siqueira@ppp.pi.gov.br", "Nome": "FRANCISCA SIQUEIRA SOARES - Matr.0338558-2" },
    "Atributos": []
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006613", "Sigla": "SEAD-PI/GAB/NTGD", "Descricao": "Núcleo Estratégico de Tecnologia e Governo Digital - SEAD-PI" },
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": []
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006178", "Sigla": "SEAD-PI/GAB/SGP", "Descricao": "Superintendência de Gestão de Pessoas - SEAD-PI" },
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": [{ "Nome": "UNIDADE", "Valor": "SEAD-PI/GAB/NTGD¥Núcleo Estratégico de Tecnologia e Governo Digital", "IdOrigem": "110006613" }]
  },
  {
  ...
  },
  {
    ...
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": [
      { "Nome": "DOCUMENTO", "Valor": "8877591", "IdOrigem": "9990895" },
      { "Nome": "USUARIO", "Valor": "ubaldojunior@sead.pi.gov.br¥UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3", "IdOrigem": "100002540" }
    ]
  },
  {
    ...
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": [
      { "Nome": "ANEXO", "Valor": "modelo.docx", "IdOrigem": "4363384" },
      { "Nome": "DOCUMENTO", "Valor": "8878806", "IdOrigem": "9992250" }
    ]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006613", "Sigla": "SEAD-PI/GAB/NTGD", "Descricao": "Núcleo Estratégico de Tecnologia e Governo Digital - SEAD-PI" },
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": [{ "Nome": "INTERESSADO", "Valor": "SEI¥Sistema Eletrônico de Informações", "IdOrigem": "11759389" }]
  },
  {
  ...
  },
  {
    ...
    "Unidade": { "IdUnidade": "110006613", "Sigla": "SEAD-PI/GAB/NTGD", "Descricao": "Núcleo Estratégico de Tecnologia e Governo Digital - SEAD-PI" },
    "Usuario": { "IdUsuario": "100002540", "Sigla": "ubaldojunior@sead.pi.gov.br", "Nome": "UBALDO DE SÁ NEVES JÚNIOR - Matr.372815-3" },
    "Atributos": [{ "Nome": "NIVEL_ACESSO", "IdOrigem": "0" }]
  }
];
